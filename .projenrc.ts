...
const project = new cdk.JsiiProject({
  ...
  name: "joshbegin/projen-pipelines",
  projenrcTs: true,
  packageManager: javascript.NodePackageManager.NPM,
  repositoryUrl: "https://github.com/joshbegin/projen-pipelines.git",
  licensed: true,
  license: "Apache-2.0",
  jsiiVersion: "~5.8",
  ...
  bundledDeps: ["standard-version"],
  peerDeps: ["projen@>=0.96.3 <1.0.0", "constructs@^10.4.2"],
  autoApproveUpgrades: true,
  autoApproveOptions: {
    allowedUsernames: ["hoegertn", "Lock128", "open-constructs-projen[bot]"],
    secret: "GITHUB_TOKEN",
  },
  depsUpgradeOptions: {
    workflowOptions: {
...
project
  .addTask("local-push", { exec: "npx yalc push" })
  .prependSpawn(project.buildTask);
